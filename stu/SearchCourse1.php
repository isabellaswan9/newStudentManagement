...
?>
 ...
 <td width="220"  valign='middle' align='center'><?php echo $row['CouName'] ?></td>
    <td width="80" valign='middle' align='center'><?php echo $row['Kind']  ?></td>
    <td width="50" valign='middle' align='center'><?php echo $row['Credit']  ?></td>
    <td width="80" valign='middle' align='center'><?php echo $row['Teacher'] ?></td>
    <td width="120" valign='middle' align='center'><?php echo $schooltime1.$schooltime2.$schooltime3  ?></td>
    </tr>
